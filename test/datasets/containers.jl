...
@testset ExtendedTestSet "TableDataset" begin
    ...
    @testset ExtendedTestSet "TableDataset from CSV" begin
        ...
        @test getobs(td, 2) == [44, " Private", 236746, " Masters", 14.0, " Divorced", " Exec-managerial", " Not-in-family", " White", " Male", 10520, 0, 45, " United-States", ">=50k"]
        @test nobs(td) == 32561
