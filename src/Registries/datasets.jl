...
function _datasetregistry(; name = "Datasets")
    registry = Registry((id = Field(String,
                                    name = "ID",
                         ...
                         loader = Field(DatasetLoader;
                                        name = "Dataset loader",
                                        formatfn = x -> FeatureRegistries.type_format));
                        name,
                        loadfn = function (row)
                            if row.loader isa DataDepLoader &&
                               startswith(row.loader.datadep, "fastai-")
